...
You can check the full TF tree with this command, the new frame should be appearing after \okt{right_gripper}:
\begin{bashcodelarge}
 ros2 run tf2_tools view_frames
\end{bashcodelarge}This will generate a PDF file with all known frames and their hierarchy.
